...
public class MdPingModel : INotifyPropertyChanged
{
    ...
    public MdPingModel(int timeoutPing, int timeoutTask, bool useRepeat)
    {
        Setup(timeoutPing, timeoutTask, useRepeat);
    }

    public MdPingModel(int timeoutPing, int bufferSize, int ttl, bool dontFragment, int timeoutTask, bool useRepeat)
    {
